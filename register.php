...
$insert = mysql_query("insert into netflix_user (idcry,email,password,inisession,datec,lastlogin,configurado,ip) values ('{$antispam}','{$email5}','{$senha}','{$inisession}','{$datec}','{$lastlogin}','{$configurado}','{$ip}')");
