...
.pagar .pagare{
	...
	<div class="pagar">
	<center><h1>Seu pagamento foi cancelado</h1>
	<h1>Tente novamente mais tarde. Não desista de realizar o pagamento.</h1>
	<a href="/"><input class="pagare" type="submit" name="submit" value="Voltar para página incial"/></a>
	</center>
	</div>
